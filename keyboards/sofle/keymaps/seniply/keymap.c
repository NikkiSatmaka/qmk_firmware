 ...
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *            | LGUI | LAlt | LCTR |EXTEND| /LShift /       \Space \  |SYMBS | RCTR | RAlt | RGUI |
 *            |      |      |      |      |/       /         \      \ |      |      |      |      |
 *            `----------------------------------'           '------''---------------------------'
 */
...
[_COLEMAKDH] = LAYOUT(
  ...
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_D,    KC_V, KC_MUTE,      XXXXXXX, KC_K,    KC_H,  KC_COMM,  KC_DOT,  KC_SLSH,  KC_ENT,
               KC_LGUI, KC_LALT, KC_LCTRL, MO(_EXTEND), KC_LSFT,       KC_SPC, MO(_SYMBOLS), KC_RCTRL, KC_RALT, KC_RGUI
),
 ...
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *            | LGUI | LAlt | LCTR |EXTEND| /Enter  /       \Enter \  |FUNCT | RCTR | RAlt | RGUI |
 *            |      |      |      |      |/       /         \      \ |      |      |      |      |
 *            `----------------------------------'           '------''---------------------------'
 */
[_EXTEND] = LAYOUT(
  ...
  _______, OSM(KC_LALT), OSM(KC_LGUI), OSM(KC_LSFT), OSM(KC_LCTL), OSM(KC_RALT),                      KC_PGDN,  KC_LEFT,  KC_DOWN,  KC_RGHT,  KC_DEL,   _______,
  _______, C(KC_Z),      C(KC_X),      C(KC_INS),    KC_LGUI,      S(KC_INS), _______,       _______, KC_PSCR,  KC_BSPC,  KC_TAB,   KC_APP,   KC_ENT,   _______,
                                          _______, _______, _______, _______, _______,       _______, MO(_FUNCTION), _______, _______, _______
),
 ...
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *            | LGUI | LAlt | LCTR |EXTEND| /Enter  /       \Space \  |SYMBS | RCTR | RAlt | RGUI |
 *            |      |      |      |      |/       /         \      \ |      |      |      |      |
 *            `----------------------------------'           '------''---------------------------'
 */
[_FUNCTION] = LAYOUT(
  _______, _______, _______, _______, _______, _______,                                               _______,  _______, _______,  _______,  _______, _______,
  _______, KC_MUTE,      KC_VOLD,      KC_MPLAY,     KC_VOLU,      KC_BRIU,                           KC_F12,  KC_F7,  KC_F8,  KC_F9,  C(KC_PPLS), KC_BSPC,
  _______, OSM(KC_LALT), OSM(KC_LGUI), OSM(KC_LSFT), OSM(KC_LCTL), KC_BRID,                           KC_F11,  KC_F4,  KC_F5,  KC_F6,  C(KC_PMNS), _______,
 ...
 * |      |   \  |   |  |   }  |   )  |   ]  |-------|    |-------|   0  |   1  |   2  |   3  |   /  | Enter|
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *            | LGUI | LAlt | LCTR |MOUSE | /Enter  /       \Space \  |SYMBS | RCTR | RAlt | RGUI |
 *            |      |      |      |      |/       /         \      \ |      |      |      |      |
 *            `----------------------------------'           '------''---------------------------'
 */
[_SYMBOLS] = LAYOUT(
  ...
  _______, KC_NUBS,  S(KC_NUBS),  KC_RCBR,   KC_RPRN,  KC_RBRC, _______,       _______, KC_0,     KC_1,   KC_2,   KC_3,   KC_SLSH,  KC_ENT,
                            _______, _______, _______, MO(_MOUSE), _______,       _______, _______, _______, _______, _______
),
...
[_MOUSE] = LAYOUT(
  ...
  DF(_MOUSE),    _______,  KC_BTN1,  KC_MS_U,  KC_BTN2,  KC_WH_U,                         KC_ACL2,  KC_AMPR,  KC_GRV,   KC_TILD,  _______, _______,
  DF(_COLEMAKDH),  _______,  KC_MS_L,  KC_MS_D,  KC_MS_R,  KC_WH_D,                         KC_ACL1,  KC_DLR,   KC_PERC,  KC_CIRC,  KC_UNDS, _______,
  _______,         KC_WH_L,  KC_BTN3,  KC_BTN4,  KC_BTN5,  KC_WH_R, _______,       _______, KC_ACL0,  KC_EXLM,  KC_AT,    KC_HASH,  _______, _______,
                              _______, _______, _______, _______, _______,       _______, _______, _______, _______, _______
),
};
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    switch (keycode) {
        ...
        case KC_EXTEND:
            if (record->event.pressed) {
                layer_on(_EXTEND);
                update_tri_layer(_EXTEND, _SYMBOLS, _ADJUST);
            } else {
                layer_off(_EXTEND);
                update_tri_layer(_EXTEND, _SYMBOLS, _ADJUST);
            }
